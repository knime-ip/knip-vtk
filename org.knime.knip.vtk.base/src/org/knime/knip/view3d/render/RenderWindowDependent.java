...
/**
 * This interface must be implemented by all classes that rely on having the vtkRenderWindow available. Think of it like
 * a Listener in Swing.
 * 
...
public interface RenderWindowDependent {
    ...
    /**
     * Called everytime the renderWindow has to be changed.
     * 
